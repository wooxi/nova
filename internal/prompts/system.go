...
type SystemInstructionInput struct {
	...
	// DraftFlowEnabled 表示写作模式是否默认启用章节草稿流程。
...
func BuildLoreAgentFlowInstruction(in LoreAgentSystemInstructionInput) string {
	...
	sb.WriteString("- 可以使用文件读写工具读取工作区文件；初始化流程最终只允许写入 CREATOR.md，不写 ideas.md、chapters/、setting/outline.md、setting/progress.md、setting/character-states.md。\n")
	...
	sb.WriteString("- 初始化 v1 不写 ideas.md，不生成大纲，不创建互动故事；互动开局先作为资料库和 CREATOR.md 中的设定沉淀。\n\n")
	sb.WriteString("## 输出方式\n")
