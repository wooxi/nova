const agents = {
  ...
  'agents.field.recentTurns': '最近回合数',
  ...
  'agents.context.recentTurnsValue': '最近 {{count}} 回合',
  'agents.context.recentTurnsNote': '控制该 Agent 运行时携带的最近用户回合数；超过 30 会按 30 处理，旧历史应通过摘要、故事记忆或明确引用进入上下文。',
